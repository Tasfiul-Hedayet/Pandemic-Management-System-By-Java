...
class ICUlist {
    ...
    public ICUlist(String cn, String s, String f, String r) {
        this.name = cn;
        this.divison = s;
        this.area = f;
        this.number = r;
...
public class ICU extends JFrame implements ActionListener {

    private static final long serialVersionUID = 1L;
    int n;
    
    ICUlist List[] = new ICUlist[n];

    String path = "C://Users//User//eclipse-workspace//Pandamic Management Project/src/ICU.txt";
    ...
    ICU() {
        ...
        this.setTitle("Pandemic Managment System - ICU");
    ...
    public void Load() {
        try {
            ...
            for (int i = 0; i < n; i++) {
                line = get.nextLine();
                arr = line.split(" ");
                List[i] = new ICUlist(arr[0], arr[1], arr[2], arr[3]);
            }
        } catch (Exception ep) {
    ...
    public void LoadTable() {
        ...
        model.addColumn("Seat Available");
